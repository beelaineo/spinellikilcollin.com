...
export const Inner = styled.div`
	${({ theme, section }: WithSection) => css`
		...
		grid-template-rows: calc(${ROW_HEIGHT} - (${theme.layout.spacing.double} * 2));
...
export const Wrapper = styled.div`
	${({ theme, section }: WithSection) => css`
		...
		min-height: ${section.layout === 'carousel' ? ROW_HEIGHT_SMALL : ROW_HEIGHT};
		padding: ${theme.layout.spacing.double};
		${section.backgroundColor ? `background-color: ${theme.color[section.backgroundColor]};` : ''}
