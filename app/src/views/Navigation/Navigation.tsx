...
interface Action {
	type: typeof OPEN_SUBMENU | typeof OPEN_CART | typeof CLOSE_MENU | typeof CLOSE_CART
	[key: string]: any
}
				...
				<SubmenuPane open={menuOpen} onMouseLeave={closeMenu}>
					{submenus.map((submenu) =>
						submenu.__typename === 'SubMenu' ? (
							<SubMenu key={submenu._key} submenu={submenu} active={currentSubmenuKey === submenu._key} justify="start" />
						) : null,
					)}
				</SubmenuPane>
			</Inner>
