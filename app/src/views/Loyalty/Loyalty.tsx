...
import { Loyalty as LoyaltyType } from '../../types'
...
import { VIPLoyaltyForm } from '../../components/Forms/Forms/VIPLoyaltyForm'
...
export const Loyalty = ({ loyalty }: LoyaltyProps) => {
  ...
  return (
    <>
      <SEO seo={seo} defaultSeo={defaultSeo} path="loyalty" />
