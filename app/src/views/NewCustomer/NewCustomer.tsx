...
import { NewCustomer as NewCustomerType } from '../../types'
...
import { VIPSignupForm } from '../../components/Forms'
import { NewCustomerForm } from '../../components/Forms/Forms/NewCustomerForm'
...
export const NewCustomer = ({ newCustomer, person }: NewCustomerProps) => {
  ...
  return (
    <>
      <SEO seo={seo} defaultSeo={defaultSeo} path="newCustomer" />
