...
const ShopDataContext = React.createContext<ShopDataContextValue | undefined>(undefined)

export const ShopDataConsumer = ShopDataContext.Consumer

export const useShopData = () => {
	const ctx = useContext(ShopDataContext)
	if (!ctx) throw new Error('useShopDataContext must be used within a ShopDataProvider')
	return ctx
}
