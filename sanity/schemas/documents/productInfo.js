export const productInfo = {
	...
	fields: [
		...
		},
		{
			name: 'ringBlocks',
			label: 'Ring Blocks',
			description: "These blocks will appear on products marked with the 'Rings' type in Shopify",
			type: 'array',
			of: [{ type: 'productInfoBlock' }],
			fieldset: 'byType',
		},
		{
			...
			description: "These blocks will appear on products marked with the 'Earrings' type in Shopify",
			type: 'array',
			of: [{ type: 'productInfoBlock' }],
		...
		},
		{
			...
			description: "These blocks will appear on products marked with the 'Bracelets' type in Shopify",
			type: 'array',
			of: [{ type: 'productInfoBlock' }],
			fieldset: 'byType',
		},
		{
			...
			description: "These blocks will appear on products marked with the 'Necklaces' type in Shopify",
			type: 'array',
			of: [{ type: 'productInfoBlock' }],
			fieldset: 'byType',
		},
